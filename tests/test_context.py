...
def test_add_remove_instances():
    ...
    ctx = _plugin.Context()
    inst = _plugin.Instance(name='Test', parent=ctx)
    ctx.remove(inst)
...
def test_instance_equality():
    ...
    inst1 = _plugin.Instance('Test1')
    inst2 = _plugin.Instance('Test2')
    inst3 = _plugin.Instance('Test2')
